...
#ifndef MEROSIPLIB_SWIFT_H
#define MEROSIPLIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MeroSipLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10MeroSipLib18CallKitCoordinator")
@interface CallKitCoordinator : NSObject
...
@class NSApplication;
SWIFT_CLASS("_TtC10MeroSipLib18MeroSipAppDelegate")
@interface MeroSipAppDelegate : NSObject <NSApplicationDelegate>
...
SWIFT_CLASS("_TtC10MeroSipLib14PushKitHandler")
